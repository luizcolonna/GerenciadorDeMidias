...
@WebServlet("/carregar-para-alteracao")
public class CarregarParaAlteracaoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public CarregarParaAlteracaoServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendRedirect("alterar.jsp?erro=id_invalido");
			return;
		}
		...
		// 6. Encaminha o item para a tela de alteração
		if (item != null) {
			// Encontrou o item: encaminha o objeto Item para o alterar.jsp
			request.setAttribute("itemParaAlterar", item);
